#!/bin/bash
experiment_name="A004_mlp_sfnc"
criterion_=( "L1Loss" )
train_dataset_=( "ukbhcp_v2_sfnc" )
train_dataset_args_=( "[]" )
train_dataset_kwargs_=( '{"N_subs":17522,"N_timepoints":-1,"sequential":false}' )
test_dataset_=( "valid" )
test_dataset_args_=( "[]" )
test_dataset_kwargs_=( "{}" )
model_=( "mlp" )
model_args_=( "[]" )
model_kwargs_=( '{"m_in":1378,"m_out":1,"h":[1024,512,256,128],"hidden_activation":"relu"}' )
