...
#train_df['loss'] = pd.to_numeric(train_df['loss'])
#valid_df['loss'] = pd.to_numeric(valid_df['loss'])
#train_df['correlation/mean'] = pd.to_numeric(train_df['correlation/mean'])
#valid_df['correlation/mean'] = pd.to_numeric(valid_df['correlation/mean'])
for plot_string in plots:
    ...
    #train_df['loss'] = [float(f) for f in train_df['loss']]
    #valid_df['loss'] = [float(f) for f in valid_df['loss']]
