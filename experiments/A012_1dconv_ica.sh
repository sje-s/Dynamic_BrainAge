#!/bin/bash
experiment_name="A012_conv1d_ica"
criterion_=( "L1Loss" )
train_dataset_=( "ukbhcp_v2_tc_static" )
train_dataset_args_=( "[]" )
...
model_=( "conv1d" )
model_args_=( "[448,52]" )
model_kwargs_=( '{"output_dim":1,"hidden_neurons":[1024,512,256],"hidden_neurons_linear":[],"maxpool_after":1}' )
