...
from dynamic_brainage.models.sequence_modeling.transformer.multi_head_attention import MultiHeadAttention
from dynamic_brainage.models.sequence_modeling.transformer.positional_encodings import SinusoidEncoding
...
class TransformerDecoder(nn.Module):
    def __init__(
        ...
        if self.embed is not None and tie_output_to_embedding:
